                                ...
                                <div class="col-lg-4">
                                    <div class="card mb-4">
                                        <div class="card-body text-center">
                                            <img src="{{ $userprofile->picture ? asset('images/' . $userprofile->picture) : asset('images/no-pic.png') }}" alt="avatar" class="rounded-circle bg-dark img-fluid" style="width: 150px">
